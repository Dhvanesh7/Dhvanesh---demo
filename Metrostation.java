...

{
	...
	{ 
		...
		String ranip = "ranip metro station";
		String vadaj = "vadaj metro station";
		String vijaynagar = "vijay nagar metro station";
		...
		System.out.println(vadaj);

		System.out.println(vijaynagar);

		System.out.println(ushmanpura);
		
		System.out.println(oldhighcourt);
		...
		System.out.println(" 2 Seconds_Metro_Station: "+vadaj);

		System.out.println(" 3 Third_Metro_Station: "+vijaynagar);
